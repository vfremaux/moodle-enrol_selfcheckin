...
/**
 * Capabilities for self check in enrolment plugin.
 *
...
$capabilities = array(
    ...
    'enrol/selfcheckin:config' => array(
        'captype' => 'write',
    ...
    'enrol/selfcheckin:manage' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/selfcheckin:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/selfcheckin:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
        )
