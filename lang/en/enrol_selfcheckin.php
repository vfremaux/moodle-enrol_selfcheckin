...
/**
 * Strings for component 'enrol_selfcheckin', language 'en'.
 *
...
$string['selfcheckin:config'] = 'Configure self check in enrol instances';
$string['selfcheckin:enrol'] = 'Enrol users';
$string['selfcheckin:manage'] = 'Manage user enrolments';
$string['selfcheckin:unenrol'] = 'Unenrol users from the course';
$string['selfcheckin:unenrolself'] = 'Unenrol self from the course';
$string['messageprovider:expiry_notification'] = 'Manual enrolment expiry notifications';
$string['now'] = 'Now';
$string['pluginname'] = 'QRCode Self Check In enrolments';
$string['pluginname_desc'] = 'The QRCode Self Check In enrolments plugin allows users to be enrolled automatically after having signed up.';
...
$string['obsoleteticket'] = 'The given ticket is overtimed and not valid anymore.';
