 ...
 *
 * @module     enrol_self_check_in/form-potential-user-selector
 * @class      form-potential-user-selector
 * @package    enrol_self_check_in
...
define(['jquery', 'core/ajax', 'core/templates', 'core/str'], function($, Ajax, Templates, Str) {
    ...
    return /** @alias module:enrol_self_check_in/form-potential-user-selector */ {
            ...
            promise[0].then(function(results) {
                ...
                if (results.length <= perpage) {
                    ...
                    $.each(results, function(index, user) {
                        ...
                        promises.push(Templates.render('enrol_self_check_in/form-user-selector-suggestion', ctx));
                    });
